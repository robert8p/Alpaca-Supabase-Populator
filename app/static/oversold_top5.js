(() => {
  ...
  window.analyseInChatGPT = function analyseInChatGPTPrefilled(id) {
    ...
    const fullPrompt = typeof buildChatGPTPrompt === 'function' ? buildChatGPTPrompt(c) : compactPrompt;
