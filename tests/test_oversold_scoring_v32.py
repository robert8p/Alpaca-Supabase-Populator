...
def test_model_is_explicitly_versioned_v37() -> None:
    ...
    assert result["catalyst_analysis"]["analysis_method"] == "rules_v3_9_auditable_deterministic_sensitivity"
    assert result["catalyst_analysis"]["reliability_version"] == "reliability_scenarios_v1"
    assert result["catalyst_analysis"]["robustness_version"] == "auditable_sensitivity_v2"
    assert result["catalyst_analysis"]["subject_attribution_version"] == "subject_attribution_v1"
    assert result["catalyst_analysis"]["local_attribution_version"] == "local_clause_attribution_v1"
